<%-- 
    Document   : Login
    Created on : Mar 28, 2019, 12:46:08 AM
    Author     : Ravi kumar
--%>
                    ...
                    <div class="contacts-find">
                        <div class="col-md-5 col-md-offset-3">
                            <div class="contacts-form" style="background-color:rgba(80,54,84,0.6);height:100%">
                                <h1 style="font-size:170%; color:White;" class="blog-title">Forgot Password ?</h1>
                                <div id="success"></div>

                                <form action="./SendEmail" method="post" id="contactForm" class="comment-form">
                                    ...
                                    <div class="comment-form__input">
                                       <input type="email" class="form-control" name="email" id="user-email" placeholder="Email" />
                                        ...
                                        <center><button type="submit" class="btn button button--red triangle triangle--12" value="SignUp">Send</button></center><br>
