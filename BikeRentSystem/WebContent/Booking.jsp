                    ...
                    <div class="col-lg-9 col-md-8 col-sm-7 col-xs-6">
                        <div class="shop">
                            <header class="shop-main__head clearfix ">
                                <h2 class="pull-left"><i class="fa fa-list"></i> LIST OF BIKES</h2>
                            ...
                            <div class="items">
                                <div class="row">
									...
									<span class="pagination__row">
										<a href="./Booking.jsp?page=<%= p-1%>" class="pagination__cell pagination__cell--nav no-decoration">&laquo;</a>
										<a href="./Booking.jsp?page=1" class="pagination__cell <%
                                                                                   if(p!=1){%>no-decoration<%}else{%>pagination__cell--active no-decoration<%}%>">1</a>
										<a href="./Booking.jsp?page=2" class="pagination__cell <%
                                                                                   if(p!=2){%>no-decoration<%}else{%>pagination__cell--active no-decoration<%}%>">2</a>
										<a href="./Booking.jsp?page=3" class="pagination__cell <%
                                                                                   if(p!=3){%>no-decoration<%}else{%>pagination__cell--active no-decoration<%}%>">3</a>
                                                                                <a href="./Booking.jsp?page=4" class="pagination__cell <%
                                                                                   if(p!=4){%>no-decoration<%}else{%>pagination__cell--active no-decoration<%}%>">4</a>
                                                                                <a href="./Booking.jsp?page=5" class="pagination__cell <%
                                                                                   if(p!=5){%>no-decoration<%}else{%>pagination__cell--active no-decoration<%}%>">5</a>
                                                                                <a href="./Booking.jsp?page=6" class="pagination__cell <%
                                                                                   if(p!=6){%>no-decoration<%}else{%>pagination__cell--active no-decoration<%}%>">6</a>
										<a href="./Booking.jsp?page=<%= p+1%>" class="pagination__cell pagination__cell--nav <%
