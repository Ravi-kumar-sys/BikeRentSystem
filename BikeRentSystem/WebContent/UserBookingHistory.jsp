        ...
        <div class="col-lg-12 col-md-12">
            ...
            <ol class="breadcrumb">
                <li ><a href="./ProfileDetails.jsp" class="menu"><i class="fa fa-user"></i> PROFILE</a>
                    ...
                    <a href="" class="active"><i class="fa fa-history"></i>HISTORY</a></li>
            </ol>
        </div>
            ...
            <div class="container">
                <div class="row row--main-shop">
                        ...
                        <%
                            ...
                            <div class="image col-lg-3 col-md-offset-1">
                         ...
                         <a href="./BookingForm.jsp?bike_id=<%= bike.getBike_id()%>" class="btn btn-primary">Rent Again</a></h2>
