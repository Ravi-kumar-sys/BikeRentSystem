        ...
        <div class="col-lg-12 col-md-12">
            ...
            <ol class="breadcrumb">
                <li ><a href="./ProfileDetails.jsp" class="menu"><i class="fa fa-user"></i> PROFILE</a>
                    ...
                    <a href="" class="active"><i class="fa fa-plus-circle"></i>TOPUP</a>
            ...
            <div class="container">
                <div class="row row--main-shop">
                            ...
                            <tr>
                                ...
                                <th>Top-up:</th>
                                <th><%=b.getTopupselected()%></th>
                            </tr>
                        </table> <br>
                                <div class="col-md-0 col-md-offset-0">
                                    <a href="./BookingDetails.jsp?bike_id=<%=bike.getBike_id()%>" class="btn btn-primary">View Topup Details</a></h2>
                                    <h3>Want to Add Top-up?</h3><h6> top-up is an amount added to extend the ride.</h6>
                                    <h4><b>Select topup:</b></h4>
                                    
                                    <form action="./AddBookingtopup" method="get">
