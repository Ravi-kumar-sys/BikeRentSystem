                    ...
                    <div class="contacts-find">
                        <div class="col-md-5 col-md-offset-3">
                            <div class="contacts-form" style="background-color:rgba(80,54,84,0.6);height:100%">
                                ...
                                <form action="./LoginCheck" method="post" id="contactForm" class="comment-form">
                                    ...
                                    <div class="comment-form__input">
                                       <input type="password" class="form-control" name="password" id="user-website" placeholder="Password" />
                                        ...
                                        <center><button type="submit" class="btn button button--red triangle triangle--12" value="SignUp">Login</button></center><br>
                                        
                                </form>
                                <a href="./Forgotpassword.jsp">Forgot your password?</a><br>
                                <a href="./Registration.jsp">Do you have account? Create new account</a>                
                           </div>
                        </div>
                    </div>
                </div >
